    ...
    { 
      ...
      render: (value: string) => (
        <span className={`font-medium ${
          parseFloat(value) > 5 ? 'text-green-600' : 
          parseFloat(value) > 3 ? 'text-yellow-600' : 'text-red-600'
        }`}>
          {value}
        </span>
      )
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="h-64 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-medium">Traffic Analytics Chart</p>
              <p className="text-sm text-gray-500">Line chart showing traffic trends</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="h-64 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">User journey visualization</p>
            </div>
          </div>
        </div>
      </div>
          ...
          {[
            ...
            <div key={index} className="text-center">
              <div className="bg-blue-100 rounded-lg p-4 mb-2">
                <div className="text-2xl font-bold text-blue-700">{item.count.toLocaleString()}</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h4 className="text-md font-semibold text-gray-900 mb-4">Top Referrers</h4>
            ...
            {[
              ...
              <div key={index} className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-sm font-medium text-gray-900">{item.visitors.toLocaleString()}</div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h4 className="text-md font-semibold text-gray-900 mb-4">Geographic Data</h4>
          <div className="space-y-3">
            {[
              ...
              <div key={index} className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium text-gray-900">{item.visitors.toLocaleString()}</span>
              </div>
            ))}
          </div>
        </div>
