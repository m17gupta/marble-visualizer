    ...
    <div className="flex items-baseline  gap-4 rounded-md border border-gray-200 bg-white px-2  mb-4">
      <div className="flex flex-grow gap-2 overflow-x-auto scroll-thin p-2 ">
        ...
        <HoverCard>
          {/* Replace PopoverTrigger with HoverCardTrigger */}
          <HoverCardTrigger asChild >
            <div className=" ps-2 pe-8 inline-flex cursor-pointer items-center gap-2 rounded-xl border border-[#25f474] bg-white px-6 py-1 shadow-sm transition-transform duration-200 hover:scale-105">
              <img
                src="https://dzinlyv2.s3.us-east-2.amazonaws.com/liv/materials/Belden__830_OTUxMTE0.jpg"
                alt="user-input"
                className="h-6 w-6 rounded-md object-cover"
        ...
        <HoverCard>
          {/* Replace PopoverTrigger with HoverCardTrigger */}
          <HoverCardTrigger asChild>
            <div className="ps-2 pe-8 inline-flex cursor-pointer items-center gap-2 rounded-xl border border-[#8622ff] bg-white px-2 py-1 shadow-sm transition-transform duration-200 hover:scale-105">
              <img
                src="https://dzinlyv2.s3.us-east-2.amazonaws.com/liv/materials/Belden__830_OTUxMTE0.jpg"
                alt="user-input"
                className="h-6 w-6 rounded-md object-cover"
          ...
          <HoverCardContent
            className="w-[240px] rounded-xl p-3 shadow-lg"
            sideOffset={8}>
            <h6 className="mb-2 text-md font-semibold">wl</h6>
            <img
        ...
        <HoverCard>
          ...
          <HoverCardContent
            className="w-[240px] rounded-xl p-3 shadow-lg"
            sideOffset={8}>
            <h6 className="mb-2 text-sm font-semibold">change the wall with with pallet image</h6>
