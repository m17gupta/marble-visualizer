        ...
        <div className='bg-white px-6 py-4 rounded-lg'>
          ...
          <Tabs defaultValue="homeOwner" className="w-full">
            <TabsList className="grid w-full  max-w-xl px-4 mx-auto grid-cols-2 md:grid-cols-4 mb-8 gap-3 h-32 md:h-14 rounded-lg bg-black/5 ">
              ...
              <TabsTrigger value="homeOwner" className="flex items-center gap-2 px-4 py-2 rounded-md bg-black/50 text-white ">
                🏠 Home Owner
              </TabsTrigger>
              <TabsTrigger value="realtor" className="flex items-center gap-2 px-4 py-2 rounded-md bg-black/50 text-white ">
                🏖️ Realtor
              </TabsTrigger>
