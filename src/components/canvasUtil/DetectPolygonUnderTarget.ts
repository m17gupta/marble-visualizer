...
// export function getOverlappingPolygonNamesFabric(
//   canvasRef: React.RefObject<fabric.Canvas>,
//   targetPolygonName: string
// ): string[] {
//   const canvas = canvasRef.current;
...
//   const target = findPolygon(canvasRef, targetPolygonName);
...
//     if (target.intersectsWithObject(poly)) {
//   overlapping.push((poly as NamedFabricObject).name ?? "Unnamed");
//     }
//   });
