...
//   // const { variations, activeVariationId } = useSelector((state: RootState) => state.aiJobs);
  
//   const [sliderValue, setSliderValue] = useState([50]);
//   const [isFullscreen, setIsFullscreen] = useState(false);
//   const containerRef = useRef<HTMLDivElement>(null);
  
//   // const projectVariations = useMemo(() => variations[projectId] || [], [variations, projectId]);
//   // const activeVariation = projectVariations.find(v => v.id === activeVariationId);
//   // const resultImageUrl = activeVariation?.imageUrl || currentJob?.full_image;
...
//     }
//   }, [projectVariations, activeVariationId, dispatch]);
...
//     if (!currentJob?.id || !resultImageUrl) return;      const result = await dispatch(uploadResultToS3({
