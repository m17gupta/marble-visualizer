    ...
    <div className="flex w-full max-w-sm flex-col gap-6">
      <Tabs defaultValue="chat" className="w-full">
        <TabsList className="grid w-full grid-cols-3 gap-2">
          <TabsTrigger value="chat" className="shadow border border-gray-600 data-[state=active]:bg-white data-[state=active]:border-blue-500 data-[state=active]:text-blue-600">
            <img
