...
const LayerContent = () => {
  ...
  const tabTriggerStyle = "py-1.5 px-6 rounded-lg text-gray-700 shadow-none border border-gray-300 data-[state=active]:bg-white data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:shadow-sm focus-ring-0 focus:ring-blue-500 focus:outline-none";
    ...
    <>
     <Tabs value={currentTab} onValueChange={handleTabChange}>
        <TabsList className="w-full py-2 gap-2">
          <TabsTrigger value="all" className={tabTriggerStyle}>Layers</TabsTrigger>
          <TabsTrigger value="pending" className={tabTriggerStyle}>Structure</TabsTrigger>
