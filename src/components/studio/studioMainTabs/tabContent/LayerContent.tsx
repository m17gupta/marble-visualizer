...
const LayerContent = () => {
  ...
  const tabTriggerStyle = "py-1.5 rounded-full text-gray-700 shadow-none border border-gray-300 data-[state=active]:bg-white data-[state=active]:border-blue-500 data-[state=active]:text-blue-600 data-[state=active]:shadow-md focus-ring-0 focus:ring-blue-500 focus:outline-none";
    ...
    <>
     <Tabs value={currentTab} onValueChange={handleTabChange}>
        <TabsList className="w-full py-2 gap-2">
          <TabsTrigger value="all" className={tabTriggerStyle}><AllCommentIcon className="pe-2" />Canvas JSON </TabsTrigger>
          <TabsTrigger value="pending" className={tabTriggerStyle}><CommentIcon className="pe-1" />Structure</TabsTrigger>
          <TabsTrigger value="resolved" className={tabTriggerStyle}><ResolvedCommentIcon className="pe-1" />Layers</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="resolved" className="p-0"><LayerSegTab/> </TabsContent>
      </Tabs>
