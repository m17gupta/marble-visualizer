...
const FilterSwatch: React.FC<FilterSwatchProps> = ({
  ...
  const { filterSwatch } = useSelector((s: RootState) => s.filterSwatch);
    ...
    <>
      ...
      >
        ...
        <div className="space-y-3 ps-4 border-b pb-3">
          <SectionTitle>
            <h5 className="font-semibold text-base text-black/80">Category</h5>
          </SectionTitle>
          <SearchCategory />
        </div>
        ...
        <div className="flex flex-col gap-2 p-3 pb-0">
          ...
          {/* Brand panel */}
          {openCard === "brand" && <SearchBrand openCard={"brand"} />}

          {/* Style panel */}
          {openCard === "style" && <SearchStyle openCard={"style"} />}
        </div>
        ...
        <div className="mt-3 px-4">
          <div className="flex items-center justify-between mb-2">
            <SectionTitle>
              <h5 className="font-semibold text-base text-black">Swatch</h5>
            </SectionTitle>
