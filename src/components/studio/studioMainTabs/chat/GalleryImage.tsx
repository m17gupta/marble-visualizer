        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
             ...
             <button
              type="button"
              className="text-base text-gray-800 hover:text-white transition p-0 inline-flex items-center"
              aria-label="Add Image"
            >
              {/* The text color on the button (text-gray-800) will be the default icon color */}
              <svg
                fill="currentColor" /* This tells the SVG to use the button's text color */
                height="24"
                viewBox="0 0 24 24"
                width="24"
