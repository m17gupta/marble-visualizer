...
const RequestMasterImage = () => {
    ...
    return (
        <>
            {genAiRequests.houseUrl ? <div className="flex-1 group relative">
                <img
                    //   src="https://testvizualizer.s3.us-east-2.amazonaws.com/uploads/images/11/CarolynReformatted_1753799607502_hgvazm.jpg"
                    src={genAiRequests?.houseUrl[0] || "https://via.placeholder.com/150"}
                    alt="Main"
                ...
                {genAiRequests &&
                genAiRequests.prompt && genAiRequests.prompt[0]  &&
                    <div
