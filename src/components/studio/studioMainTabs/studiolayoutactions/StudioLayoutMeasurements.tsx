...
export default function StudioLayoutMeasurements() {
  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
             ...
             <button className="grid place-items-center rounded-full bg-blue-600 text-white shadow-lg hover:scale-105 active:scale-[0.97] transition-transform focus:outline-none leading-none  [&>svg]:block shrink-0 w-10 h-10 justify-center" title="Comments">
