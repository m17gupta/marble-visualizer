    ...
    return (
      <div className=" flex flex-col items-center justify-center grid items-start content-center h-[90%]">
        ...
        <p className="text-gray-500 mb-2 text-center">
         ...
         <Button className="btn-primary bg-primary hover:bg-primary/90 text-white hover:text-white w-32 mx-auto" variant="outline" size="sm"  onClick={handleAddSegment}>
           Select Segment                   
         </Button>     
