              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-x-2 text-xs text-muted-foreground mt-1">
                  ...
                  {extendedSegment.perimeter_pixel && (
                    <span className="flex items-center">
                      ...
                      {extendedSegment.perimeter_feet && (
                        <span className="ml-1">({extendedSegment.perimeter_feet}ft)</span>
                      )}
                    </span>
                  )}
                  ...
                  {extendedSegment.bb_area_pixel && (
                    <span>
                      ...
                      {extendedSegment.bb_area_sqft && (
                        <span className="ml-1">({extendedSegment.bb_area_sqft}ft²)</span>
                      )}
                    </span>
                  )}
                  ...
                  {extendedSegment.annotation_type && (
                    <Badge 
                      variant={extendedSegment.annotation_type === 'manual' ? 'default' : 'secondary'} 
                  ...
                  <div className="mt-2 pt-2 border-t border-dashed border-muted-foreground/20 space-y-1">
                    ...
                    {extendedSegment.bb_dimension_pixel && (
                      <div className="flex items-center text-xs text-muted-foreground">
                        ...
                        {extendedSegment.bb_dimension_pixel[0]} × {extendedSegment.bb_dimension_pixel[1]} px
                        {extendedSegment.bb_dimension_feet && (
                          <span className="ml-1">({extendedSegment.bb_dimension_feet[0]} × {extendedSegment.bb_dimension_feet[1]} ft)</span>
                        )}
                      </div>
                    )}
                      ...
                      <>
                            ...
                            <div className="flex items-start gap-1">
                              ...
                              <p className="text-[10px] text-muted-foreground break-all">
                                {extendedSegment.svg_path.length > 50
                                  ? `${extendedSegment.svg_path.substring(0, 50)}...`
                                  : extendedSegment.svg_path}
                              </p>
                            </div>
                            <SVGPathPreview 
                        ...
                        {extendedSegment.annotation && (
                          <div className="text-xs text-muted-foreground">
                            <span className="font-medium">Annotation points:</span>{' '}
                        ...
                        {extendedSegment.skew_value && (
                          <div className="text-xs text-muted-foreground">
                            ...
                            X: {extendedSegment.skew_value.skew_x.toFixed(2)}, 
                            Y: {extendedSegment.skew_value.skew_y.toFixed(2)}
                          </div>
                        )}
                      </>
                    )}
